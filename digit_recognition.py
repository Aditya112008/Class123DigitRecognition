...
import PIL.ImageOps
import os, ssl, time
#Since we are running the python script locally on our maching the 
#openml thinks that our python script cannot be trusted since there is no ssl, which a browser automatically provides 
